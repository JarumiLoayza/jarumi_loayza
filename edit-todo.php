            ...
            <div class="col-md-5 mx-auto">
                <div class="card bg-white rounded border shadow">
                    <div class="card-header px-4 py-3">
                        <h4 align="center" class="card-title"><FONT COLOR="NARANJA"><strong>EDITAR TAREA </strong></FONT></h4>
                    </div>
                    <div class="card-body p-4">
                        ...
                        <form action="" method="POST">
                            ...
                            <div>
                                <button type="submit" name="updateTodo" class="btn btn-warning">ACTUALIZAR</button>
