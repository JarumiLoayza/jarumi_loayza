            ...
            <div class="col-md-5 mx-auto">
                <div class="card bg-white rounded border shadow">
                    <div class="card-header px-4 py-3">
                        <h2 align="center" class="card-title"><FONT COLOR="cyan"><strong><em>CREANDO TAREA </em></strong></FONT></h2>
                    </div>
                    <div class="card-body p-4">
                        <?php echo $msg; ?>
                        <form action="" method="POST">
                            <div class="mb-3">
                                <label for="title" class="form-label"><strong>Tarea</strong></label>
                            ...
                            <div class="mb-3">
                                <label for="desc" class="form-label"><strong>Descripcion</strong></label>
                                <textarea class="form-control" id="desc" name="desc" rows="3" required><?php if (isset($_POST["addTodo"])) {
                                                                                                            echo $_POST["title"];
                                                                                                        } ?></textarea>
                            </div>
                            <div>
                                <button type="submit" name="addTodo" class="btn btn-warning"><strong>CREAR</strong></button>
                                <button type="reset" class="btn btn-danger"><strong>CANCELAR</strong></button>
                            </div>
                        </form>
                    </div>
                </div>
